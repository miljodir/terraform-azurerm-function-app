...
resource "azurerm_windows_function_app" "windows_function" {
  ...
  dynamic "site_config" {
    ...
    content {
      ...
      minimum_tls_version               = lookup(site_config.value, "min_tls_version", startswith(local.function_app_name, "d-") ? "1.3" : "1.2")
      ...
      scm_minimum_tls_version     = lookup(site_config.value, "scm_minimum_tls_version", startswith(local.function_app_name, "d-") ? "1.3" : "1.2")
